...
var ApexClassModel = require(getFilePath('/lib/models/ApexClass'));
var ApexEnumModel = require(getFilePath('/lib/models/ApexEnum'));
var ApexMethodModel = require(getFilePath('/lib/models/ApexMethod'));
var ApexPropertyModel = require(getFilePath('/lib/models/ApexProperty'));
